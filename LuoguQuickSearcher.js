...
function mainfunc() {
    ...
    if (document.readyState == "complete") {
        ...
        newElement.style.height = newElement.style.width = "auto";
        newElement.style.borderRadius = "3px";
        newElement.style.backgroundColor = bgColor;
        var appElement = document.getElementById('app');
        appElement.appendChild(newElement);
        newElement.children[0].style = "box-sizing: border-box;border: 1px solid #ccc;border-radius: 5px;background: rgba(255,255,255,0.3);font-weight: bold;outline: 0;";
